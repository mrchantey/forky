...
const SHADER_UTILITY: ForkyShader =
	forky_shader!("utility", SHADER_HANDLE_OFFSET_INTERNAL + 0).as_static();
const SHADER_NOISE: ForkyShader =
	forky_shader!("noise", SHADER_HANDLE_OFFSET_INTERNAL + 2).as_static();
const SHADER_SDF2: ForkyShader =
	forky_shader!("sdf2", SHADER_HANDLE_OFFSET_INTERNAL + 2).as_static();
const SHADER_SDF3: ForkyShader =
	forky_shader!("sdf3", SHADER_HANDLE_OFFSET_INTERNAL + 3).as_static();
