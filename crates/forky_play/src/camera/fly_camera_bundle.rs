...
impl FlyCameraBundle {
    pub fn new(name: &'static str, transform: Transform, view_type: CameraViewType) -> Self {
        Self {
            name: name.into(),
            camera: default(),
            transform,
    ...
    pub fn right() -> Self {
        Self::new(
            "Right Camera",
            Transform::from_translation(Vec3::new(10., 0., 0.)).with_rotation(Quat::from_right()),
    ...
    pub fn forward() -> Self {
        Self::new(
            "Forward Camera",
            Transform::from_translation(Vec3::new(0., 0., 10.)).with_rotation(Quat::from_forward()),
    ...
    pub fn up() -> Self {
        Self::new(
            "Up Camera",
            Transform::from_translation(Vec3::new(0., 10., 0.)).with_rotation(Quat::from_up()),
            CameraViewType::Top,
        )
    }
