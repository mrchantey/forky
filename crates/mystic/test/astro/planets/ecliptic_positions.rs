...
sweet! {
	...
	test "ecliptic positions"{
		...
		expect(*ecliptic_positions::moon(day))
			.to_be(RectCoords { x: -0.17071703140942265, y: 0.9671373403660894, z: 0.000244455888348224 })?;
		expect(*ecliptic_positions::mercury(day))
			.to_be(RectCoords { x: -0.14072937612299719, y: -0.44390213113733545, z: -0.023343754406466743 })?;
		expect(*ecliptic_positions::venus(day))
			.to_be(RectCoords { x: -0.7186427978467534, y: -0.022558508614733574, z: 0.041172246944286506 })?;
		expect(*ecliptic_positions::earth(day))
			.to_be(RectCoords { x: -0.16859614540661194, y: 0.9687542029346362, z: 0.0 })?;
		expect(*ecliptic_positions::jupiter(day))
			.to_be(RectCoords { x: 4.004410412346112, y: 2.9373123101736742, z: -0.10175564366099876 })?;
		expect(*ecliptic_positions::saturn(day))
			.to_be(RectCoords { x: 6.407513191982934, y: 6.565128118257096, z: -0.3699571287452595 })?;
		expect(*ecliptic_positions::uranus(day))
			.to_be(RectCoords { x: 14.425425328151979, y: -13.737612206413395, z: -0.23802068662353199 })?;
		expect(*ecliptic_positions::neptune(day))
			.to_be(RectCoords { x: 16.796170232469972, y: -24.982713961883295, z: 0.12733440092952736})?;
		expect(*ecliptic_positions::pluto(day))
			.to_be(RectCoords { x: -9.892380757344934, y: -27.99251636591456, z: 5.858940692166365 })?;
	}
